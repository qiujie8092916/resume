...
$(function() {
  ...
  $("#github").hover(function() {
    $(this).find("img").attr("src", imgs.misc.github_2)
  }, function() {
    $(this).find("img").attr("src", imgs.misc.github_1)
  })
      ...
      var article = '<div class="center-block article">\
                      <div class="icon_div" style="height:100px;">\
                          <ul class="list-unstyled list-inline ski_icon">\
                              ...
                              <li class="li_icon animated">\
                                  <img src="' + imgs.brief.js + '" class="icon animated" id="icon_js">\
                              </li>\
                              <li class="li_icon animated">\
                                  <img src="' + imgs.brief.css + '" class="icon animated" id="icon_css">\
                              </li>\
                              <li class="li_icon animated">\
                                  <img src="' + imgs.brief.more + '" class="icon animated" id="icon_more">\
                              </li>\
                          </ul>\
                      </div>\
                  </div>'
        ...
        if (ii < 6) {
          for (var key in iitem) {
            ...
            var base_sentense = '<div class="pro-module animated" data-index="' + ii + '">\
                                    <img src="' + imgs.gallery[key] + '" />\
                                    <div class="background-shadow">\
                                        <a href="' + (key === "ci" ? '/project_dao/' + key + '/vip.html' : key === "pospa" ? "/project_dao/pospa/pospa/admin.html" : "/project_dao/" + key + '/index.html') + '" target="_blanck" class="btn btn_custom btn-default center-block">Check It</a>\
                                    </div>\
                                </div>'
            if (ii >= 0 && ii < 3) {
        ...
        $.each(e, function(ii, ee) {
          if (ii === "picture") {
            subbody += '<div class="cd-timeline-img ' + ee + '-backgroundColor is-hidden">\
                            <img src="' + imgs.misc[ee] + '" alt="Picture">\
                        </div>'
          } else {
...
function openWind() {
  $.when(defer('php/visitdom.php')).done(function(data) {
